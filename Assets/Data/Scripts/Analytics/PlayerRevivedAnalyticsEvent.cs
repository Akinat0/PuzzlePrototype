...
namespace Puzzle.Analytics
{
    public class PlayerRevivedAnalyticsEvent : PuzzleAnalyticsEvent
    {
        ...
        void PlayerReviveEvent_Handler()
        {
            ...
            EventData["freeze_booster"] = GameSceneManager.Instance.Session.SessionBoosters.Any(booster => booster is TimeFreezeBooster);
            EventData["live_booster"] = GameSceneManager.Instance.Session.SessionBoosters.Any(booster => booster is HeartBooster);
